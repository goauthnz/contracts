...
func (c *PtfmAuthSvcClient) CreateAccountWithEmailPassword(ctx context.Context, email string, password string) (*ptfm_auth_svc_v1_entities.Account, string, error) {

...
func (c *PtfmAuthSvcClient) CreateAccountWithPhonePassword(ctx context.Context, phone string, password string) (*ptfm_auth_svc_v1_entities.Account, string, error) {

...
func (c *AuthnzStoreSvcClient) CreateSessionWithEmailPassword(ctx context.Context, email string, password string) (*authnz_store_svc_v1_entities.Session, error) {

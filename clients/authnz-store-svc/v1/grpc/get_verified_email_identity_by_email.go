...
func (c *AuthnzStoreSvcClient) GetVerifiedEmailIdentityByEmail(ctx context.Context, email string) (*authnz_store_svc_v1_entities.EmailIdentity, error) {
	...
	return &authnz_store_svc_v1_entities.EmailIdentity{

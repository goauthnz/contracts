...
func (c *AuthnzStoreSvcClient) GetSessionByID(ctx context.Context, id string) (*authnz_store_svc_v1_entities.Session, error) {
	req := connect.NewRequest(&pb.GetSessionByIDRequest{
		Id: wrapperspb.String(id),
	})

	res, err := c.client.GetSessionByID(ctx, req)
	if err != nil {
